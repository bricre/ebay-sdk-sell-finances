 ...
 * transaction retrieved with the <strong>Finances API</strong>, including an order
 * total, a seller payout, a buyer refund, or a seller credit.
 */
class Amount extends AbstractModel
{
     ...
     * only returned when eBay does a currency version, and a currency conversion is
     * generally needed if the buyer is viewing, or has purchased an item on an
     * international site. <br><br>This field is only returned if/when currency
